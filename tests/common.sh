...
function install_ide()
{
    ...
    echo "compiler.c.extra_flags=-Wall -Wextra -Werror -Wformat=2 $debug_flags" > esp8266/platform.local.txt
    echo "compiler.cpp.extra_flags=-Wall -Wextra -Werror -Wformat=2 $debug_flags" >> esp8266/platform.local.txt
    echo -e "\n----platform.local.txt----"
